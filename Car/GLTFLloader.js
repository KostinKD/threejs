( function () {
    ...
    function computeBounds( geometry, primitiveDef, parser ) {
        ...
        if ( targets !== undefined ) {
            ...
            for ( let i = 0, il = targets.length; i < il; i ++ ) {
                ...
                if ( target.POSITION !== undefined ) {
                    ...
                    if ( min !== undefined && max !== undefined ) {
                        ...
                        // boxes. So for now we make a torus that's sometimes a touch too small but is hopefully mostly of reasonable size.
            ...
            // As per comment above this torus isn't conservative, but has a reasonable size for a very large number of morph targets.
